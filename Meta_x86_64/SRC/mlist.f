...
CREATE  INPUT_PATH 0 , 60 ALLOT
CREATE  OUTPUT_PATH 0 , 60 ALLOT

MODULE: AVRLIST

CREATE  FILE_NAME_L 120 ALLOT
CREATE  FILE_NAME_S 120 ALLOT
 ...
 *)
      ...
      2DUP  - 7 U> IF CR TAB ." DQ " DUP @ AHH. CELL+ THEN
		...
		THEN DUP @  AHH. CELL+
          ...
          2DUP = if  NIP CR BREAK
             CR TAB ." DB 0x"  COUNT  H.-
             BEGIN  2DUP U> 
             WHILE
                DUP $7 AND 
		IF   ." ,0x"  ELSE  CR TAB ." DB 0x"
		THEN COUNT H.-			 
             REPEAT
  NIP CR
