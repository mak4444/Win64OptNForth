...
CREATE LTAB 0 C, 2 C, 1 C, 3 C,

: lea,

  #(%r_x),%r_x		IF REX.RBX LTAB + C@ TO REX.RBX
			 SWAP [']  #%r_x,(%r_x)	>PARM 0x8C ADD|  BREAK
...
FLOAD Meta_x86_64/SRC/lex.4th 
FLOAD Meta_x86_64/SRC/prefix.4th 
